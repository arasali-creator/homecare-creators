...
<div class="ticker-wrap" aria-hidden="true">
  <div class="ticker-inner">
    <div class="ticker-item"><i class="fa-solid fa-laptop-code"></i>Orlando Homecare Website Design</div><div class="ticker-dot"></div>
    <div class="ticker-item"><i class="fa-solid fa-map-location-dot"></i>Orange County SEO</div><div class="ticker-dot"></div>
    <div class="ticker-item"><i class="fa-solid fa-mobile-screen"></i>Mobile-First Development</div><div class="ticker-dot"></div>
    <div class="ticker-item"><i class="fa-brands fa-google"></i>Rank #1 on Google Orlando</div><div class="ticker-dot"></div>
  ...
  <div class="container">
    ...
    <div class="pkg-grid" data-reveal style="transition-delay:.1s">
      <div class="pkg-card">
        ...
        <ul class="pkg-list">
          <li><i class="fa-solid fa-check"></i>5 custom Orlando-specific pages</li>
          <li><i class="fa-solid fa-check"></i>Mobile-first design with your branding</li>
          <li><i class="fa-solid fa-check"></i>On-page SEO for Orlando keywords</li>
      ...
      <div class="pkg-card featured">
        ...
        <ul class="pkg-list">
          ...
          <li><i class="fa-solid fa-check"></i>3 Orlando neighborhood area pages</li>
      ...
      <div class="pkg-card">
        ...
        <ul class="pkg-list">
          ...
          <li><i class="fa-solid fa-check"></i>8 Orlando neighborhood area pages</li>
...
<section class="areas-section">
  <div class="container">
    ...
    <div class="areas-grid" data-reveal style="transition-delay:.1s">
      ...
      <div class="area-pill"><div class="area-dot"></div>Kissimmee</div>
      ...
      <div class="area-pill"><div class="area-dot"></div>Altamonte Springs</div>
      <div class="area-pill"><div class="area-dot"></div>Sanford</div>
      <div class="area-pill"><div class="area-dot"></div>Lake Mary</div>
      <div class="area-pill"><div class="area-dot"></div>Longwood</div>
      <div class="area-pill"><div class="area-dot"></div>Casselberry</div>
      <div class="area-pill"><div class="area-dot"></div>Winter Garden</div>
      <div class="area-pill"><div class="area-dot"></div>Clermont</div>
      <div class="area-pill"><div class="area-dot"></div>Celebration</div>
      <div class="area-pill"><div class="area-dot"></div>Doctor Phillips</div>
      <div class="area-pill"><div class="area-dot"></div>College Park</div>
      <div class="area-pill"><div class="area-dot"></div>Windermere</div>
      <div class="area-pill"><div class="area-dot"></div>Pine Hills</div>
      <div class="area-pill"><div class="area-dot"></div>Azalea Park</div>
      <div class="area-pill"><div class="area-dot"></div>Conway</div>
      <div class="area-pill"><div class="area-dot"></div>Sky Lake</div>
    </div>
  </div>
</section>
...
<section class="results-section">
  <div class="container">
    <div style="text-align:center" data-reveal>
      ...
      <h2 class="section-h2" style="color:#fff;text-align:center">What Happens After Your<br><em>Orlando Website Goes Live</em></h2>
    </div>
  ...
  <div class="container">
    <div class="cta-inner">
      ...
      <div class="cta-img-wrap" data-reveal style="transition-delay:.15s">
        <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&q=80&fit=crop" alt="Orlando homecare agency website design results">
