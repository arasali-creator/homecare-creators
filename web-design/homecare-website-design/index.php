...
.mockup-url{flex:1;background:rgba(255,255,255,.1);border-radius:6px;padding:5px 12px;font-family:'Plus Jakarta Sans',sans-serif;font-size:10px;color:rgba(255,255,255,.6)}
...
.mockup-stat-num{font-family:'Plus Jakarta Sans',sans-serif;font-size:14px;font-weight:800;color:var(--teal)}
...
.mockup-speed-num{font-family:'Plus Jakarta Sans',sans-serif;font-size:18px;font-weight:800;color:var(--teal)}
.mockup-speed-label{font-size:9px;color:var(--muted);font-family:'Plus Jakarta Sans',sans-serif;font-weight:600}
...
.mockup-rank-num{font-family:'Plus Jakarta Sans',sans-serif;font-size:22px;color:var(--teal-lt);line-height:1}
.mockup-rank-label{font-size:9px;color:rgba(255,255,255,.5);font-family:'Plus Jakarta Sans',sans-serif;font-weight:600}
...
.what-body p{font-size:18px;line-height:1.8;color:var(--muted);margin-bottom:16px}
...
.what-point-title{font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;font-size:15px;color:var(--forest);margin-bottom:4px}
.what-point-desc{font-size:15.5px;line-height:1.6;color:var(--muted)}
...
.what-stat-num{font-family:'Plus Jakarta Sans',sans-serif;font-size:38px;color:var(--teal);line-height:1}
.what-stat-label{font-size:11px;color:var(--muted);font-family:'Plus Jakarta Sans',sans-serif;font-weight:600;margin-top:3px}
...
.what-badge-text{font-family:'Plus Jakarta Sans',sans-serif;font-size:12px;font-weight:700;color:#fff}
...
.compare-table th{background:var(--forest);color:#fff;font-family:'Plus Jakarta Sans',sans-serif;font-size:12px;font-weight:700;padding:16px 20px;text-align:left;letter-spacing:.5px}
...
.portfolio-tag{position:absolute;top:14px;left:14px;background:var(--teal);color:#fff;font-family:'Plus Jakarta Sans',sans-serif;font-size:10px;font-weight:700;padding:4px 10px;border-radius:20px;letter-spacing:.5px}
.portfolio-body{padding:20px}
.portfolio-name{font-family:'Plus Jakarta Sans',sans-serif;font-size:15px;font-weight:700;color:var(--forest);margin-bottom:4px}
.portfolio-meta{font-size:13px;color:var(--muted)}
.portfolio-stat{display:flex;align-items:center;gap:6px;margin-top:12px;font-family:'Plus Jakarta Sans',sans-serif;font-size:12px;font-weight:700;color:var(--teal)}
...
<section class="packages-section" id="packages">
  <div class="container">
    ...
    <div style="background:rgba(29,158,117,.06);border:1px solid rgba(29,158,117,.2);border-radius:16px;padding:28px 32px;margin-top:32px;display:flex;align-items:center;gap:20px;flex-wrap:wrap">
      ...
      <div style="flex:1"><div style="font-family:Syne,sans-serif;font-weight:700;font-size:16px;color:var(--forest);margin-bottom:4px">Pair Your New Website With SEO</div><p style="font-size:14px;color:var(--muted)">Pair your website with our <a href="/seo/home-care-seo/" style="color:var(--teal);font-weight:600">Home Care SEO</a> service for Google Maps rankings and organic visibility.</p></div>
      <a href="/seo/home-care-seo/" class="btn-primary" style="white-space:nowrap;font-size:13px;padding:12px 20px"><i class="fa-solid fa-arrow-right"></i>View SEO Plans</a>
    </div>
...
<section style="background:var(--cream);padding:64px 40px">
  <div class="container" style="text-align:center">
    <p class="section-label" style="justify-content:center">Where We Build</p>
    <h2 class="section-h2" style="text-align:center">Homecare Website Design<br><em>Across Florida</em></h2>
    <p class="section-sub" style="max-width:640px;margin:16px auto 0">Every city page below is a live example of the work, tuned to that market's own neighborhoods, keywords, and families.</p>
    <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap;margin-top:32px">
      <a href="/homecare-website-design-miami-fl/" style="display:inline-flex;align-items:center;gap:10px;background:#fff;border:1px solid var(--border);border-radius:14px;padding:18px 24px;text-decoration:none;transition:.25s" onmouseover="this.style.borderColor='var(--teal)'" onmouseout="this.style.borderColor='var(--border)'">
      ...
      <a href="/homecare-website-design-orlando-fl/" style="display:inline-flex;align-items:center;gap:10px;background:#fff;border:1px solid var(--border);border-radius:14px;padding:18px 24px;text-decoration:none;transition:.25s" onmouseover="this.style.borderColor='var(--teal)'" onmouseout="this.style.borderColor='var(--border)'">
        <i class="fa-solid fa-location-dot" style="font-size:18px;color:var(--teal)"></i>
      ...
      <a href="/homecare-website-design-tampa-fl/" style="display:inline-flex;align-items:center;gap:10px;background:#fff;border:1px solid var(--border);border-radius:14px;padding:18px 24px;text-decoration:none;transition:.25s" onmouseover="this.style.borderColor='var(--teal)'" onmouseout="this.style.borderColor='var(--border)'">
        <i class="fa-solid fa-location-dot" style="font-size:18px;color:var(--teal)"></i>
      ...
      <a href="/homecare-website-design-jacksonville-fl/" style="display:inline-flex;align-items:center;gap:10px;background:#fff;border:1px solid var(--border);border-radius:14px;padding:18px 24px;text-decoration:none;transition:.25s" onmouseover="this.style.borderColor='var(--teal)'" onmouseout="this.style.borderColor='var(--border)'">
        <i class="fa-solid fa-location-dot" style="font-size:18px;color:var(--teal)"></i>
      ...
      <a href="/homecare-website-design-fort-lauderdale-fl/" style="display:inline-flex;align-items:center;gap:10px;background:#fff;border:1px solid var(--border);border-radius:14px;padding:18px 24px;text-decoration:none;transition:.25s" onmouseover="this.style.borderColor='var(--teal)'" onmouseout="this.style.borderColor='var(--border)'">
        <i class="fa-solid fa-location-dot" style="font-size:18px;color:var(--teal)"></i>
      ...
      <a href="/homecare-website-design-naples-fl/" style="display:inline-flex;align-items:center;gap:10px;background:#fff;border:1px solid var(--border);border-radius:14px;padding:18px 24px;text-decoration:none;transition:.25s" onmouseover="this.style.borderColor='var(--teal)'" onmouseout="this.style.borderColor='var(--border)'">
        <i class="fa-solid fa-location-dot" style="font-size:18px;color:var(--teal)"></i>
