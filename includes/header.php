...
<?php if ($_hc_favicon_url): ?><link rel="icon" href="<?= htmlspecialchars($_hc_favicon_url) ?>"><?php else: ?><link rel="icon" type="image/svg+xml" href="/images/home/favicon.svg"><link rel="alternate icon" href="/favicon.ico"><?php endif ?>
