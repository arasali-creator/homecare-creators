...
.blog-hero h1{font-family:'Instrument Serif',serif;font-size:clamp(36px,5vw,56px);color:#fff;position:relative;z-index:1;margin-bottom:12px}
.blog-hero p{font-size:16px;color:rgba(255,255,255,.55);position:relative;z-index:1;font-family:'Syne',sans-serif;max-width:500px;margin:0 auto}
...
.blog-card-cat{font-family:'Syne',sans-serif;font-size:10.5px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:var(--teal);margin-bottom:10px}
.blog-card-title{font-family:'Syne',sans-serif;font-size:18px;font-weight:700;color:var(--forest);line-height:1.35;margin-bottom:10px}
.blog-card-title a{color:inherit;text-decoration:none}
.blog-card-title a:hover{color:var(--teal)}
.blog-card-excerpt{font-size:14px;color:var(--muted);line-height:1.65;flex:1;margin-bottom:16px}
