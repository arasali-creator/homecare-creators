...
.post-breadcrumb{display:flex;align-items:center;gap:6px;font-family:'Plus Jakarta Sans',sans-serif;font-size:12px;color:rgba(255,255,255,.45);margin-bottom:20px;text-decoration:none}
...
.post-kw{font-family:'Plus Jakarta Sans',sans-serif;font-size:10px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:var(--teal);background:rgba(29,158,117,.15);padding:5px 12px;border-radius:20px;display:inline-block;margin-bottom:16px}
.post-hero h1{font-family:'Plus Jakarta Sans',sans-serif;font-size:clamp(28px,4vw,52px);color:#fff;line-height:1.18;margin-bottom:20px;max-width:800px}
...
.post-avatar span{color:#fff;font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:700}
.post-author-info{display:flex;flex-direction:column}
.post-author-name{font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:700;color:#fff}
.post-author-meta{font-size:12px;color:rgba(255,255,255,.4)}
.post-sep{width:1px;height:24px;background:rgba(255,255,255,.15)}
.post-reading{font-size:12px;color:rgba(255,255,255,.45);font-family:'Plus Jakarta Sans',sans-serif}
...
.post-article{}
.post-article h2{font-family:'Plus Jakarta Sans',sans-serif;font-size:clamp(22px,2.8vw,34px);font-weight:600;color:var(--forest);margin:52px 0 16px;line-height:1.25}
.post-article h3{font-family:'Plus Jakarta Sans',sans-serif;font-size:clamp(19px,2.2vw,26px);font-weight:400;color:var(--forest);margin:36px 0 12px;line-height:1.3}
.post-article p{font-size:18px;line-height:1.88;color:#374151;margin-bottom:22px}
.post-article ul,.post-article ol{margin:0 0 22px 22px;display:flex;flex-direction:column;gap:10px}
.post-article li{font-size:18px;line-height:1.7;color:#374151}
...
.inline-cta-text h4{font-family:'Plus Jakarta Sans',sans-serif;font-size:16px;font-weight:800;color:#fff;margin-bottom:5px}
.inline-cta-text p{font-size:15px;color:rgba(255,255,255,.55);margin:0}
.inline-cta-btn{flex-shrink:0;background:var(--teal);color:#fff;border:none;padding:12px 22px;border-radius:50px;font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:700;cursor:pointer;white-space:nowrap;transition:.2s}
...
.sidebar-cta-card p{font-size:14.5px;color:rgba(255,255,255,.5);margin-bottom:20px;line-height:1.6}
.sidebar-cta-btn{display:block;background:var(--teal);color:#fff;border:none;padding:13px 20px;border-radius:50px;font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:700;cursor:pointer;width:100%;transition:.2s;text-align:center}
...
.sidebar-card-title{font-family:'Plus Jakarta Sans',sans-serif;font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted);margin-bottom:14px}
...
.author-avatar-lg span{color:#fff;font-family:'Plus Jakarta Sans',sans-serif;font-size:20px;font-weight:700}
.author-name{font-family:'Plus Jakarta Sans',sans-serif;font-size:14px;font-weight:700;color:var(--forest)}
...
.related-card-title{font-family:'Plus Jakarta Sans',sans-serif;font-size:15px;font-weight:700;color:var(--forest);line-height:1.35;margin-bottom:6px}
...
.post-bottom-cta .eyebrow{font-family:'Plus Jakarta Sans',sans-serif;font-size:10px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:var(--teal);margin-bottom:16px}
.post-bottom-cta h2{font-family:'Plus Jakarta Sans',sans-serif;font-size:clamp(28px,4vw,46px);color:#fff;margin-bottom:14px;line-height:1.2}
.post-bottom-cta p{font-size:18px;color:rgba(255,255,255,.55);margin-bottom:32px;line-height:1.7}
.post-bottom-cta-btns{display:flex;gap:14px;justify-content:center;flex-wrap:wrap}
.btn-cta-primary{background:var(--teal);color:#fff;border:none;padding:16px 32px;border-radius:50px;font-family:'Plus Jakarta Sans',sans-serif;font-size:15px;font-weight:700;cursor:pointer;transition:.2s;text-decoration:none}
.btn-cta-primary:hover{background:#178a64;transform:translateY(-2px);box-shadow:0 8px 28px rgba(29,158,117,.4)}
.btn-cta-ghost{background:transparent;color:rgba(255,255,255,.7);border:1.5px solid rgba(255,255,255,.2);padding:15px 28px;border-radius:50px;font-family:'Plus Jakarta Sans',sans-serif;font-size:15px;font-weight:600;cursor:pointer;transition:.2s;text-decoration:none}
...
.trust-item{display:flex;align-items:center;gap:6px;font-size:12.5px;color:rgba(255,255,255,.4);font-family:'Plus Jakarta Sans',sans-serif}
...
<div class="post-body-wrap">
  ...
  <aside class="post-sidebar">
    ...
    <div class="sidebar-card" style="background:rgba(29,158,117,.05);border-color:rgba(29,158,117,.2)">
      <div style="font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:700;color:var(--forest);margin-bottom:8px">Struggling to get new clients?</div>
      ...
      <button onclick="openPopup('starter')" style="background:var(--teal);color:#fff;border:none;padding:10px 18px;border-radius:50px;font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:700;cursor:pointer;width:100%;transition:.2s">View Our Packages</button>
    </div>
...
<div class="related-section">
  <div class="related-inner">
    <div style="font-family:'Plus Jakarta Sans',sans-serif;font-size:10px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:var(--teal);margin-bottom:10px">Keep Reading</div>
    <div style="font-family:'Plus Jakarta Sans',sans-serif;font-size:clamp(24px,3vw,36px);color:var(--forest)">More Homecare Marketing Insights</div>
    <div class="related-grid">
      ...
      <a href="/blog/<?= htmlspecialchars($r['slug']) ?>" class="related-card">
        ...
        <div class="related-card-img" style="background:linear-gradient(135deg,var(--forest),var(--teal));display:flex;align-items:center;justify-content:center">
          <span style="font-family:'Plus Jakarta Sans',sans-serif;color:rgba(255,255,255,.2);font-size:36px">HC</span>
        </div>
        <?php endif ?>
