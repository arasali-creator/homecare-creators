<?php
$page_title = "Home Care Agency Marketing in Miami, FL | Homecare Creators";
$page_desc = "Homecare Creators helps Miami homecare agencies rank #1 on Google, build professional websites, and grow private-pay clients across Miami-Dade County, FL.";
$page_canonical = "https://homecarecreators.com/Marketing/home-care-miami-fl.php";
$og_title = "Home Care Agency Marketing in Miami, FL | Homecare Creators";
$og_desc = "Miami homecare agencies — get found on Google, dominate local search, and grow faster with the only agency built 100% for homecare in Florida.";
$page_css = <<<CSS
/* HERO */
...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-h1">Home Care Agency<br>Marketing in <em>Miami, FL</em></h1>
    ...
    <div class="services-grid">
      <div class="svc-card" data-reveal style="transition-delay:.05s">
        <div class="svc-card-img">
          <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&q=80&fit=crop" alt="Homecare website design Miami FL">
      ...
      <div class="svc-card" data-reveal style="transition-delay:.1s">
        <div class="svc-card-img">
          <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=600&q=80&fit=crop" alt="Local SEO homecare Miami">
          <div class="svc-card-img-overlay"></div>
      ...
      <div class="svc-card" data-reveal style="transition-delay:.15s">
        <div class="svc-card-img">
          <img src="https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=600&q=80&fit=crop" alt="AI search SEO homecare Miami">
          <div class="svc-card-img-overlay"></div>
  ...
  <div class="container">
    <div class="cta-inner">
      ...
      <div class="cta-image" data-reveal style="transition-delay:.15s">
        <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&q=80&fit=crop" alt="Miami homecare agency owner growing business">
