<?php
$page_title = "Home Care Agency in Jacksonville, FL | Homecare Creators";
$page_desc = "Homecare Creators helps Jacksonville homecare agencies rank #1 on Google, build professional websites, and grow private-pay clients across Duval County, FL.";
$page_canonical = "https://homecarecreators.com/home-care-jacksonville-fl/";
$og_title = "Home Care Agency Marketing in Jacksonville, FL | Homecare Creators";
...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-h1">Home Care Agency<br>Marketing in <em>Jacksonville, FL</em></h1>
